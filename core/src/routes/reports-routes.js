...
export async function reportsRoutes(app) {
  app.get("/stock", { config: { cacheOnRequest: { key: () => "reportes:stock" } }, preHandler: [app.requirePermission("reportes", "ver")] }, async (request) => {
  ...
  app.get("/ganancias", { config: { cacheOnRequest: { key: (r) => `reportes:ganancias:${r.query.periodo || "mes"}` } }, preHandler: [app.requirePermission("reportes", "ver")] }, async (request) => {
  ...
  app.get("/ganancias/evolucion", { config: { cacheOnRequest: { key: () => "reportes:ganancias:evolucion" } }, preHandler: [app.requirePermission("reportes", "ver")] }, async (request) => {
